...
//   const [newMember, setNewMember] = useState({ fullName: '', email: '', department: 'Customer Support' });
  ...
  //   const response = await axios.get('https://api.gsbpathy.com/api/teams/all-members');
  //   return response.data.data;
  // };

  // const getAssignedChats = async (memberId: string) => {
  //   const response = await axios.get(`https://api.gsbpathy.com/api/teams/team-members/${memberId}/assigned-chats`);
  //   return response.data.data;
  // };

  // const addTeamMember = async (data: { fullName: string; email: string; department: string }) => {
  //   const response = await axios.post('https://api.gsbpathy.com/api/teams/add-member', data);
